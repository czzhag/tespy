'''
calib file using for keck python analysis. changed from matlab version calib.m
05/08/2018
'''
import numpy as np
...
def calib_keck():
	...
	calib["M_FB"] = np.array([-7.99]*16)    #Mux07-15, Mux09-8, Mux11-25
	calib["M_FB"][2] = -calib["M_FB"][2]
	
	calib["R_WIRE"] = np.array([48.00]*16)    #ohms include in R_FB and R_BIAS
	...
	calib["R_FB"] = np.array([15000.00]*16)
